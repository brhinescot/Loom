...
<head runat="server">
    <title></title>
    <loom:StyleSheet runat="server">
        <Externals>
            <loom:ExternalResource Path="~/styleresource/common.css"/>
            <loom:ExternalResource Path="~/styleresource/tables.css"/>
            <loom:ExternalResource Path="~/styleresource/menu.css"/>
        </Externals>
    </loom:StyleSheet>
</head>
<body>
