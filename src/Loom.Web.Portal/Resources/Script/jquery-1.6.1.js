    ...
    jQuery.support = (function() {
        ...
        if (document.defaultView && document.defaultView.getComputedStyle) {
            ...
            support.reliableMarginRight =
                (parseInt((document.defaultView.getComputedStyle(marginDiv, null) || { marginRight: 0 }).marginRight,
                        10) ||
                    0) ===
                0;
        }
            ...
            filter: {
                PSEUDO: function(elem, match, i, array) {
                    ...
                    if (filter) {
                        ...
                        return (elem.textContent || elem.innerText || Sizzle.getText([elem]) || "").indexOf(match[3]) >=
                            0;
            ...
            if (jQuery.isArray(selectors)) {
                ...
                if (cur && selectors.length) {
                    for (i = 0, l = selectors.length; i < l; i++) {
                        ...
                        if (!matches[selector]) {
                            matches[selector] =
                                POS.test(selector) ? jQuery(selector, context || this.context) : selector;
                        }
                    }
            ...
            jQuery.each(obj,
                function(i, v) {
                    if (traditional || rbracket.test(prefix)) {
                        ...
                        buildParams(prefix + "[" + (typeof v === "object" || jQuery.isArray(v) ? i : "") + "]",
                            v,
                            traditional,
                            add);
                    }
