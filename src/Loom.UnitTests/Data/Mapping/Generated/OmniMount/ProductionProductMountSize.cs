...
{
    /// <summary>
    ///     This is an DataRecord class which wraps the Production.ProductMountSize table.
    /// </summary>
    [Serializable]
    [XmlSchemaProvider("CreateSchema")]
    [ActiveTable("Production", "ProductMountSize", "ProductId")]
    public class ProductMountSize : DataRecord<ProductMountSize>
    {
        private int _mountSizeId;

        private int _productId;

        public ProductMountSize() { }
        protected ProductMountSize(SerializationInfo info, StreamingContext context) : base(info, context) { }
        ...
        /// <summary>
        /// </summary>
        [ActiveColumn("MountSizeId", DbType.Int32, ColumnProperties.PrimaryKey | ColumnProperties.Unique, Ordinal = 2, MaxLength = 0)]
