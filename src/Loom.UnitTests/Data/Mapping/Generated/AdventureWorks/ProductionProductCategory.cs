...
namespace AdventureWorks.Production
{
    ...
    [ActiveTable("Production", "ProductCategory", "ProductCategoryID", ModifiedOnColumn = "ModifiedDate")]
    public class ProductCategory : DataRecord<ProductCategory>
    {
        ...
        /// </summary>
        [ActiveColumn("ProductCategoryID", DbType.Int32, ColumnProperties.Identity | ColumnProperties.PrimaryKey | ColumnProperties.Unique, Ordinal = 1, MaxLength = 0)]
