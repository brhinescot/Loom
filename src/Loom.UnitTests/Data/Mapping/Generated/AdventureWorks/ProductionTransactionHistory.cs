...
{
    /// <summary>
    ///     This is an DataRecord class which wraps the Production.TransactionHistory table.
    /// </summary>
    [Serializable]
    [XmlSchemaProvider("CreateSchema")]
    [ActiveTable("Production", "TransactionHistory", "TransactionID", ModifiedOnColumn = "ModifiedDate")]
    public class TransactionHistory : DataRecord<TransactionHistory>
    {
        ...
        /// </summary>
        [ActiveColumn("TransactionID", DbType.Int32, ColumnProperties.Identity | ColumnProperties.PrimaryKey | ColumnProperties.Unique, Ordinal = 1, MaxLength = 0)]
