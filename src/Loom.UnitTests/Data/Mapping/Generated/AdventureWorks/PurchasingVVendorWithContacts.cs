...
{
    /// <summary>
    ///     This is an DataRecord class which wraps the Purchasing.vVendorWithContacts table.
    /// </summary>
    [Serializable]
    [XmlSchemaProvider("CreateSchema")]
    [ActiveTable("Purchasing", "vVendorWithContacts", ReadOnly = true)]
    public class VVendorWithContacts : DataRecord<VVendorWithContacts>
    {
        ...
        protected VVendorWithContacts(SerializationInfo info, StreamingContext context) : base(info, context) { }
