...
{
    /// <summary>
    ///     This is an DataRecord class which wraps the Sales.vStoreWithAddresses table.
    /// </summary>
    [Serializable]
    [XmlSchemaProvider("CreateSchema")]
    [ActiveTable("Sales", "vStoreWithAddresses", ReadOnly = true)]
    public class VStoreWithAddresses : DataRecord<VStoreWithAddresses>
    {
        ...
        protected VStoreWithAddresses(SerializationInfo info, StreamingContext context) : base(info, context) { }
