...
{
    /// <summary>
    ///     This is an DataRecord class which wraps the dbo.Summary of Sales by Quarter table.
    /// </summary>
    [Serializable]
    [XmlSchemaProvider("CreateSchema")]
    [ActiveTable("dbo", "Summary of Sales by Quarter", ReadOnly = true)]
    public class SummaryOfSalesByQuarter : DataRecord<SummaryOfSalesByQuarter>
    {
        ...
        protected SummaryOfSalesByQuarter(SerializationInfo info, StreamingContext context) : base(info, context) { }
