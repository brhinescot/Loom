...
{
    /// <summary>
    ///     This is an DataRecord class which wraps the dbo.Customers table.
    /// </summary>
    [Serializable]
    [XmlSchemaProvider("CreateSchema")]
    [ActiveTable("dbo", "Customers", "CustomerID")]
    public class Customers : DataRecord<Customers>
    {
        ...
        public Customers() { }
        protected Customers(SerializationInfo info, StreamingContext context) : base(info, context) { }

        /// <summary>
        /// </summary>
        [ActiveColumn("CustomerID", DbType.String, ColumnProperties.PrimaryKey | ColumnProperties.Unique, Ordinal = 1, MaxLength = 5)]
