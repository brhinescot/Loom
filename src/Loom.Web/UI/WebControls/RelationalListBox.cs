...
namespace Loom.Web.UI.WebControls
{
    ...
    ///         like any other list control until the <see cref="RelationalListBox.ParentListId" /> property is set.
    ...
    ///  ]]></code>
    ///     <para>
    ///         See the <see cref="RelationalListBox.RegisterClientScript" /> method for an example on how to use
    ...
    [ToolboxData("<{0}:RelationalListBox runat=server></{0}:RelationalListBox>")]
    [ToolboxBitmap(typeof(RelationalListBox), "Loom.Web.UI.WebControls.RelationalListBox.bmp")]
    public class RelationalListBox : ListBox, IRelationalListControl, ILocalizable, ISpamGuardian
    {
        ...
        /// </summary>
        private readonly ControlExtender<RelationalListBox> extender;
        ...
        public RelationalListBox()
        {
            extender = new ControlExtender<RelationalListBox>(this);
        }

        /// <summary>
        ///     Gets or sets if the first item in the <see cref="RelationalListBox" /> will exist for all
            ...
            set
            {
                if (value == null)
                    throw new ArgumentNullException("value", string.Format("Null Argument Exception: Null value for argument '{0}' passed into method '{1}'.", "value",
                        "DevInterop.Web.UI.WebControls.RelationalListBox.ParentListID"));
        ...
        /// <summary>
        ///     Overrides <see cref="System.Web.UI.Control.CreateControlCollection" /> to disable adding child controls to this
        ///     control.
        /// </summary>
        /// <remarks>
        ///     As implemented, returns an <b>EmptyControlCollection</b> to disable adding child controls to this control.
        /// </remarks>
        /// <returns>Returns an <see cref="System.Web.UI.EmptyControlCollection" />.</returns>
        ...
        /// <summary>
        ///     Overrides <see cref="System.Web.UI.Control.OnPreRender" /> to register the client script for the
        ///     <see cref="RelationalListBox">
        ///         RelationalListBox
        ///     </see>
        ///     .
        /// </summary>
        ...
        ///     <see cref="RelationalListBox">RelationalListBox</see>.
        /// </summary>
        /// <remarks>
        ///     <para>
        ...
        /// <summary>
        ///     Registers the resource script for the <see cref="RelationalListBox">RelationalListBox</see> control.
        /// </summary>
        ...
        ///     the <see cref="RelationalListBox">RelationalListBox</see>
        ///     control.
        /// </summary>
        ...
        /// <summary>
        ///     Overrides <see cref="System.Web.UI.Control.LoadViewState" />.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        ///     Overrides <see cref="System.Web.UI.Control.SaveViewState" />.
        /// </summary>
        /// <remarks>
