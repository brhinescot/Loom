...
namespace Loom.Web.Syndication
{
    ...
    internal class RssElementCustomTypeDescriptor : ICustomTypeDescriptor
    {
        ...
        {
            PropertyDescriptor[] propertyDescriptors = new PropertyDescriptor[attributes.Count];
            int i = 0;
        ...
        private class RssElementCustomPropertyDescriptor : PropertyDescriptor
        {
            ...
            public override Type ComponentType => typeof(RssElementCustomTypeDescriptor);
            ...
            public override object GetValue(object o)
            {
                ...
                if (element != null)
                {
                    ...
                    if (element.attributes.TryGetValue(Name, out propertyValue))
