...
{
    /// <summary>
    ///     A mutable lookup implementing <see cref="System.Linq.ILookup{TKey,TElement}" />
    /// </summary>
    /// <typeparam name="TKey"> The lookup key. </typeparam>
    /// <typeparam name="TElement">
    ///     The elements under each <typeparamref name="TKey" /> .
    /// </typeparam>
    public class MutableLookup<TKey, TElement> : ILookup<TKey, TElement>
    {
        ...
        public MutableLookup() : this(EqualityComparer<TKey>.Default) { }
        ...
        /// <returns>
        ///     The elements under <paramref name="key" /> .
        /// </returns>
        ...
        /// <returns>
        ///     <c>true</c> if <paramref name="key" /> is present.
        /// </returns>
        ...
        {
            foreach (MutableLookupGrouping g in groupings.Values)
                yield return g;
        ...
        /// </summary>
        public int Count => groupings.Count + (nullGrouping != null && nullGrouping.Count > 0 ? 1 : 0);

        #endregion

        /// <summary>
        ///     Adds <paramref name="element" /> under the specified <paramref name="key" /> . <paramref name="key" /> does not
        ///     need to exist.
        /// </summary>
        /// <param name="key">
        ///     The key to add <paramref name="element" /> under.
        /// </param>
        ...
        /// </summary>
        /// <param name="key">
        ///     The key that <paramref name="element" /> is located under.
        /// </param>
        /// <param name="element">
        ///     The element to remove from <paramref name="key" /> .
        /// </param>
        /// <returns>
        ///     <c>true</c> if <paramref name="key" /> and <paramref name="element" /> existed, <c>false</c> if not.
        /// </returns>
        ...
        /// <returns>
        ///     <c>true</c> if <paramref name="key" /> existed.
        /// </returns>
        ...
        protected virtual void ElementAdded(TKey key, TElement element) { }

        #region Nested type: MutableLookupGrouping
