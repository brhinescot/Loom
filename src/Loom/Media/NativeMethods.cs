...
namespace Loom.Media
{
    internal static class NativeMethods
    {
        ...
        #region WMT_CODEC_INFO_TYPE enum
        ...
        #region Nested type: IWMHeaderInfo3
        ...
        public interface IWMHeaderInfo3
        {
            ...
            uint GetAttributeByIndexEx(
                ...
                [Out] [MarshalAs(UnmanagedType.LPArray)] byte[] pValue,
                [Out] [In] ref ushort pdwDataLength);
        ...
        #region Nested type: IWMMetadataEditor
