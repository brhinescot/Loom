...
namespace Loom.Data.Mapping.Providers
{
    public class SqlServerCommandBuilder : CommandBuilder
    {
        ...
        protected override string ParameterPrefix => ParameterPrefixValue;

        protected override string WildcardCharacter => WildcardCharacterValue;
        ...
        protected override string GetComparisonOperator(Comparison comparison, object value)
        {
            switch (comparison)
            {
                ...
                default:
                    throw new ArgumentException("Unrecognized comparison.", nameof(comparison));
            }
        }
        ...
        #region Nested type: SqlComparisonOperator
