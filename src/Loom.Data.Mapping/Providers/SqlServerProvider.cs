...
namespace Loom.Data.Mapping.Providers
{
    internal sealed class SqlServerProvider : SqlDataSessionProvider, IActiveDataProvider
    {
        ...
        #region IActiveDataProvider Members
        ...
        {
            Argument.Assert.IsNotNull(codeGenQuery, nameof(codeGenQuery));
        ...
        public DbCommand FetchCommand(Insert insert)
        {
            ...
            foreach (KeyValuePair<IQueryableColumn, object> pair in columnValues.Where(p => !Equals(insert.Table.IdentityColumn, p.Key)))
        ...
        private DbCommand FetchCommand(Delete delete)
        {
            ...
            foreach (ColumnPredicate predicate in delete.WherePredicates)
        ...
        {
            Argument.Assert.IsNotNull(dataType, nameof(dataType));
        ...
        #region Nested type: SchemaValue
