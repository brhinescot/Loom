...
namespace Loom.Data.Mapping
{
    ...
    [Serializable]
    [DebuggerDisplay("Table=[{DataRecord<TDataRecord>.Table.Owner,nq}.{DataRecord<TDataRecord>.Table.Name,nq}], IsDirty={IsDirty}")]
        ...
        where TDataRecord : DataRecord<TDataRecord>, new()
    {
        ...
        private static readonly Lazy<ITable> TableSingleton = new Lazy<ITable>(() =>
        {
            ITable table = TableData.CreateUnitialized(typeof(TDataRecord));
            return table;
        });
        ...
        {
            DataRecordVersions = new DataRecordVersions<TDataRecord>(Properties, this);
        }
        ...
        protected DataRecord(SerializationInfo info, StreamingContext context)
        {
            foreach (SerializationEntry entry in info)
            {
                ...
                Properties[entry.Name].InvokeSetterOn((TDataRecord) this, entry.Value);
            }
        ...
        /// </summary>
        public static ITable Table => TableSingleton.Value;

        [DiffVisible(false)]
        [XmlIgnore]
        public bool IsLoadedFromDatasource
        {
            get => flags[LoadedFromDatasource];
        ...
        [DiffVisible(false)]
        [XmlIgnore]
        internal int DataRecordHistorySteps => DataRecordVersions.HistorySteps;

        [DiffVisible(false)]
        [XmlIgnore]
        private DataRecordVersions<TDataRecord> DataRecordVersions { get; }
        ...
        internal object this[IQueryableColumn column]
        {
            get
            {
                ...
                return property?.InvokeGetterOn((TDataRecord) this);
            }
            set
            {
                DynamicProperty<TDataRecord> property = Properties[column.Name];
                property?.InvokeSetterOn((TDataRecord) this, value);
            }
        }
        ...
        /// </summary>
        /// <param name="context">
        ///     The destination (see <see cref="System.Runtime.Serialization.StreamingContext"></see>)
        ...
        void ISerializable.GetObjectData(SerializationInfo info, StreamingContext context)
        {
            foreach (DynamicProperty<TDataRecord> property in Properties)
                info.AddValue(property.Name, property.InvokeGetterOn((TDataRecord) this));
        ...
        /// </summary>
        /// <param name="reader">
        ///     The <see cref="T:System.Xml.XmlReader" /> stream from
        ///     which the object is deserialized.
        /// </param>
        ...
        /// </summary>
        /// <param name="writer">
        ///     The <see cref="T:System.Xml.XmlWriter" /> stream to
        ///     which the object is serialized.
        /// </param>
        ...
        /// <summary>
        ///     Resets all property values to the state of the previous <see cref="Insert" />, <see cref="Update" /> or
        ///     <see cref="SaveVersion" /> specified by
        ...
        /// <summary>
        ///     Creates an xml schema for the derived classes. This method is specified by the
        ...
        protected virtual void WriteXml(XmlWriter writer)
        {
            ...
            foreach (DynamicProperty<TDataRecord> property in Properties)
            {
                object value = property.InvokeGetterOn((TDataRecord) this);
                if (value == null)
                    continue;
        ...
        /// <returns>
        ///     A <see cref="Loom.Data.Diff" /> instance representing the differences between the property values
        ///     of this instance and the cached values of the <see cref="Diff.DiffBaseline" />.
        /// </returns>
        ...
        /// </summary>
        /// <returns>
        ///     A <see cref="DiffBaseline" /> representing the current values of all the properties
        ///     of this instance.
        /// </returns>
