...
{
    [Serializable]
    [DebuggerDisplay("ParentTable = {ParentTable.FullNameBracketed,nq}, Count = {Count}")]
    public sealed class TableColumnDefinitionCollection : ICollection<TableColumnDefinition>
    {
        ...
        #region ICollection<TableColumnDefinition> Members
        ...
        /// </returns>
        bool ICollection<TableColumnDefinition>.IsReadOnly => false;
