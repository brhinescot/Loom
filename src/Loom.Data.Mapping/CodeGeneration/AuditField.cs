...
namespace Loom.Data.Mapping.CodeGeneration
{
    ...
    public struct AuditField : ISerializable
    {
        ...
        [NonSerialized] private readonly BitVector32 auditFlags;
        ...
        /// </summary>
        public bool IsAny => auditFlags[isUser] || auditFlags[isDate] || auditFlags[isModified] || auditFlags[isCreated] || auditFlags[isDeleted];

        /// <summary>
        ///     Gets a value indicating if the associated field is not an audit field.
        /// </summary>
        public bool IsNone => !(auditFlags[isUser] || auditFlags[isDate] || auditFlags[isModified] || auditFlags[isCreated] || auditFlags[isDeleted]);

        /// <summary>
        ///     Gets a value indicating if the associated field is a user audit field.
        /// </summary>
        public bool IsUser => auditFlags[isUser];

        /// <summary>
        ///     Gets a value indicating if the associated field is a date audit field.
        /// </summary>
        public bool IsDate => auditFlags[isDate];

        /// <summary>
        ///     Gets a value indicating if the associated field is a modified audit field.
        /// </summary>
        public bool IsModified => auditFlags[isModified];

        public bool IsModifiedUser => auditFlags[isModified] && auditFlags[isUser];

        public bool IsModifiedDate => auditFlags[isModified] && auditFlags[isDate];

        /// <summary>
        ///     Gets a value indicating if the associated field is a created audit field.
        /// </summary>
        public bool IsCreated => auditFlags[isCreated];

        public bool IsCreatedUser => auditFlags[isCreated] && auditFlags[isUser];

        public bool IsCreatedDate => auditFlags[isCreated] && auditFlags[isDate];

        /// <summary>
        ///     Gets a value indicating if the associated field is a deleted audit field.
        /// </summary>
        public bool IsDeleted => auditFlags[isDeleted];
