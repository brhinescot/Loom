...
// // ************************************************************************
// // LoomFramework - DataSession.cs
// // 
// // Copyright © 2004, 2013 Colossus Interactive, LLC
// // All Rights Reserved
// //    
...
namespace Loom.Data.Mapping
{
    ...
    public class DataSession : DataSessionBase<IActiveDataProvider>
    {
        ...
        {
            get { return Configuration.Localization.DefaultLocale; }
        }
        ...
        {
            TableData table = DataRecord<TDataRecord>.Table;
        ...
        public void InsertMany<TDataRecord>(IEnumerable<TDataRecord> items) where TDataRecord : DataRecord<TDataRecord>, new()
        {
            ...
            InsertMany(items, transaction == null ? IsolationLevel.Serializable : transaction.IsolationLevel);
        }
        ...
        {
            Transaction transaction = Transaction.Current;
            UpdateMany(items, transaction == null ? IsolationLevel.Serializable : transaction.IsolationLevel);
        }
        ...
        public void Delete<TDataRecord>(TDataRecord record) where TDataRecord : DataRecord<TDataRecord>, new()
        {
            ...
            Argument.Assert.IsNotNull(record, Argument.Names.record);
        ...
        public void Delete<TDataRecord>(object primaryKeyValue) where TDataRecord : DataRecord<TDataRecord>, new()
        {
            ...
            Argument.Assert.IsNotNull(primaryKeyValue, Argument.Names.primaryKeyValue);
        ...
        public void Delete<TDataRecord>(ColumnPredicate predicate) where TDataRecord : DataRecord<TDataRecord>, new()
        {
            ...
            Argument.Assert.IsNotNull(predicate, Argument.Names.predicate);
        ...
        private class DynamicRecord : DynamicObject
        {
            ...
            public DynamicRecord(TableData table)
            {
                this.table = table;
            }
        ...
        public void DeleteMany<TDataRecord>(IEnumerable<TDataRecord> items) where TDataRecord : DataRecord<TDataRecord>, new()
        {
            ...
            Argument.Assert.IsNotNull(items, Argument.Names.items);

            Transaction transaction = Transaction.Current;
            DeleteMany(items, transaction == null ? IsolationLevel.Serializable : transaction.IsolationLevel);
        }
        ...
        private void DeletePrivate(ColumnPredicate predicate, bool obliterate)
        {
            ...
            TableData table = predicate.Column.Table;
        ...
        {
            Transaction transaction = Transaction.Current;
            ObliterateMany(items, transaction == null ? IsolationLevel.Serializable : transaction.IsolationLevel);
        }
            ...
            where TDataRecord : DataRecord<TDataRecord>, new()
        {
            ...
            foreach (DynamicProperty<TDataRecord> property in DataEntity<TDataRecord>.Properties)
            {
                ...
                if (column != null)
                    queryTree.WherePredicates.Add(((QueryColumn) column).IsEqualTo(property.InvokeGetter(record)));
            }
            return QueryFirstInternal<TDataRecord>(queryTree);
        }
            ...
            where TDataRecord : DataRecord<TDataRecord>, new()
        {
            ...
            Argument.Assert.IsNotNull(columnPredicate, Argument.Names.comparison);
            ...
            where TDataRecord : DataRecord<TDataRecord>, new()
        {
            ...
            Argument.Assert.IsNotNull(commandText, Argument.Names.commandText);
        ...
        #region Fetch Collection Methods   
            ...
            where TDataRecord : DataRecord<TDataRecord>, new()
        {
            ...
            Argument.Assert.IsNotNegative(count, Argument.Names.count);
            ...
            where TDataRecord : DataRecord<TDataRecord>, new()
        {
            ...
            foreach (DynamicProperty<TDataRecord> property in record.GetUpdatedProperties())
            {
                IQueryableColumn column = DataRecord<TDataRecord>.Table.Columns.FindColumn(property.AttributeName);
                if (column != null)
                    entitySet.Where(((QueryColumn) column).IsEqualTo(property.InvokeGetter(record)));
            }
            return entitySet;
        }
            ...
            where TDataRecord : DataRecord<TDataRecord>, new()
        {
            ...
            Argument.Assert.IsNotNull(orderByColumn, Argument.Names.orderByColumn);
            EntitySet<TDataRecord> entitySet = EntitySet<TDataRecord>();
        ...
        private Update CreateUpdate<TDataRecord>(TDataRecord record) where TDataRecord : DataRecord<TDataRecord>, new()
        {
            ...
            foreach (DynamicProperty<TDataRecord> property in record.GetUpdatedProperties())
            {
                ...
                if ((column.ColumnProperties & ColumnProperties.Identity) != ColumnProperties.Identity &&
                    ...
                    update.ColumnValues.Add(column, property.InvokeGetter(record));
            }
        ...
        private Insert CreateInsert<TDataRecord>(TDataRecord record) where TDataRecord : DataRecord<TDataRecord>, new()
        {
            ...
            foreach (DynamicProperty<TDataRecord> property in record.GetUpdatedProperties())
            {
                ...
                if ((column.ColumnProperties & ColumnProperties.Identity) != ColumnProperties.Identity &&
                    (column.ColumnProperties & ColumnProperties.Computed) != ColumnProperties.Computed)
                {
                    insert.ColumnValues.Add(column, property.InvokeGetter(record));
                }
            }
        ...
        ///     The <see cref="DataRecord{TDataRecord}" /> is read only.
        /// </exception>
        private static void AssertNotReadOnly(TableData table)
        {
            if (table.IsReadOnly)
        ...
        private static void ValidateQuerySchema<TDataRecord>(CommandTree<QueryTree> query)
            where TDataRecord : DataRecord<TDataRecord>, new()
        {
            Argument.Assert.IsNotNull(query, Argument.Names.query);
        ...
        #region Internal QueryTree Operations
