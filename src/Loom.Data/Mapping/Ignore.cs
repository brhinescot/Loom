...
namespace Loom.Data.Mapping
{
    ...
    /// }
    /// </code>
    /// <para>If departmentName is null or an empty string, the following query will 
    /// be generated for SQL Server:</para>
    /// <code>
    ///     SELECT * FROM [HumanResources].[Department] _t0
    ///     WHERE _t0.[DepartmentID] = @p0;
    /// </code>
    /// <para>If departmentName is NOT null, the following query will be generated 
    /// for SQL Server:</para>
    /// <code>
    ///     SELECT * FROM [HumanResources].[Department] _t0
    ///     WHERE _t0.[DepartmentID] = @p0
    ...
    /// </code>
    /// </example>
    /// <seealso cref="QueryCondition{T}"/>
    /// <seealso cref="CommandTree{T}"/>
    [Flags]
    public enum Ignore
    {
        /// <summary>
