...
namespace Loom.Data.Mapping.Query
{
    ...
    public class ColumnPredicate : IPredicate<ColumnPredicate>, IBindablePredicate, IEquatable<ColumnPredicate>
    {
        ...
        public IQueryableColumn Column { get; private set; }
        ...
        #region IPredicate<T> Implementation

        /// <exception cref="ArgumentException">Only one instance of each <see cref="ColumnPredicate"/> 
        ...
        public bool IsJoinPredicate
        {
            get { return Value is IQueryableColumn; }
        }
