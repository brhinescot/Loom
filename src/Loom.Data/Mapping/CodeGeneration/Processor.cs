...
namespace Loom.Data.Mapping.CodeGeneration
{
    ...
    public class Processor : IFileProcessor
    {
        ...
        {
            Argument.Assert.IsNotNullOrEmpty(configurationFilePath, Argument.Names.configurationFilePath);
        ...
        {
            Argument.Assert.IsNotNullOrEmpty("session", Argument.Names.session);
