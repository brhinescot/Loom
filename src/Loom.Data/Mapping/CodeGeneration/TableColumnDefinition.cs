...
namespace Loom.Data.Mapping.CodeGeneration
{
    ///<summary>
    ///</summary>
    [Serializable, DebuggerDisplay("{FullNameBracketed,nq}, DbType={DbType}, IsIdentity={IsIdentity}")]
    public sealed class TableColumnDefinition
    {
        ...
        {
            get { return flags[isLocalizable]; }
        ...
        public string Description
        {
            ...
            internal set
            {
                description = value.Replace(Environment.NewLine, Environment.NewLine + "/// ");
            }
        }
        ...
        /// </summary>
        /// <returns>A <see cref="TableColumnDefinition"/> if this column is a foreign key, 
        /// or <see langword="null"/> if it is not.</returns>
